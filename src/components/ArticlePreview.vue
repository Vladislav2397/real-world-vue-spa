<template>
    <div class="article-preview">
        <article-meta :author-username="author.username" :created-at="article.createdAt" :author-image="author.image">
            <article-favorites-button class="pull-xs-right" :favorited="article.favorited"
                :favorites-count="article.favoritesCount" :slug="article.slug" />
        </article-meta>
        <router-link :to="{
        ...
        <div class="pull-xs-right">
            <span v-for="tag in visibleTags" :key="tag" class="tag-pill tag-default tag-outline">
                {{ tag }}
            </span>
